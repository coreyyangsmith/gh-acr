"""Bypass4 multi-agent merge resolver package.
...
Entry point `resolve_conflict_bypass4_multi_agent_node` composes the above into
...
__all__ = ["resolve_conflict_bypass4_multi_agent_node"]
...
def resolve_conflict_bypass4_multi_agent_node(state: Dict[str, Any]) -> Dict[str, Any]:  # noqa: D401
    sg = StateGraph(dict)
