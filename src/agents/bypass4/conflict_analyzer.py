...
Stores normalized decision in state["bypass_decision"] (ALL_A, ALL_B, MIX),
short form in state["bypass_method"] (A, B, MIX), and raw output.
"""
...
_PROMPT_PATH = Path(__file__).resolve().parents[2] / "prompts" / "bypass4" / "conflict_judge_prompt.txt"
