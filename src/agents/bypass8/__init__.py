"""Bypass8 multi-agent merge resolver package."""
...
__all__ = ["resolve_conflict_bypass8_multi_agent_node"]
...
def resolve_conflict_bypass8_multi_agent_node(state: Dict[str, Any]) -> Dict[str, Any]:  # noqa: D401
    sg = StateGraph(dict)
