...
Usage (examples):
  - python -m src.analysis.figures.create_em_venn_diagram --results-csv data/2025_10_18_Final_Results.csv --output-path results/venn_exact_match.png --group-by model_name --em-distributions --em-prefix results/em_dist
