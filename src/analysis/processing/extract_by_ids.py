...
- Module form (recommended):
  python -m src.analysis.processing.extract_by_ids data\invalid_ids.txt data\main.csv data\extracted.csv

- With custom ID column:
  python -m src.analysis.processing.extract_by_ids data\invalid_ids.txt data\main.csv data\extracted.csv --id-column "Unnamed: 0"

Example:
  python -m src.analysis.processing.extract_by_ids data\invalid_ids.txt data\git_good_bench_merge_commits_all_working.csv data\invalid_rows.csv
"""
