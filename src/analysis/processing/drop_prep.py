...
- Module form (recommended):
  python -m src.analysis.processing.drop_prep data\input.csv data\output_no_prep.csv

- Direct script:
  python src\results\processing\drop_prep.py data\input.csv data\output_no_prep.csv

Example:
  python -m src.analysis.processing.drop_prep data\2025_09_20_results_gemma_all.csv data\2025_09_20_results_gemma_all_no_prep.csv
"""
