...
Usage examples:
  - From repo root:
      python -m src.analysis.processing.remove_extra_columns --input data/2025_10_18_ALL_RESULTS.csv --max-columns 20
  - With explicit output path:
      python -m src.analysis.processing.remove_extra_columns -i data/in.csv -n 12 -o data/in_first12cols.csv
"""
