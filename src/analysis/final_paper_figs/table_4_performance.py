...
Usage::
    ...
    python -m src.analysis.final_paper_figs.table_4_performance
"""
...
from src.analysis.rq1.config import DEFAULT_CONFIG as RQ1_DEFAULT_CONFIG
from src.analysis.rq1.data import compute_paired_delta_statistics
