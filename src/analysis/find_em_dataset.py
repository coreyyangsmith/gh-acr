...
Usage:
    python -m src.analysis.find_em_dataset --input-csv data/2025_10_07_ALL_RESULTS.csv
    # writes data/2025_10_07_ALL_RESULTS_exact_matches.csv by default

Or specify an explicit output path:
    python -m src.analysis.find_em_dataset --input-csv data/2025_10_07_ALL_RESULTS.csv --output-csv results/em_subset.csv
"""
