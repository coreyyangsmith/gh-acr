...
Usage::
    ...
    python -m src.results.final_paper_figs.run_all
...
try:
    ...
    from src.results.final_paper_figs.table_1_dataset_summary import generate_table_1
    from src.results.final_paper_figs.table_3_fail_set import generate_table_3
    from src.results.final_paper_figs.table_4_performance import generate_table_4
    from src.results.final_paper_figs.figure_b_bypass_advantage import generate_figure_b
    from src.results.final_paper_figs.figure_c_decision_outcomes import generate_figure_c
