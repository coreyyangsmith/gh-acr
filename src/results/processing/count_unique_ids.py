...
- Module form (recommended):
    python -m src.results.processing.count_unique_ids data/2025_10_18_ALL_RESULTS.csv

- Direct script:
    python src/results/processing/count_unique_ids.py data/input.csv --id-column id
