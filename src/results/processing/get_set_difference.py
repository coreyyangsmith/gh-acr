...
class Flags:
    ...
    Examples:
      python -m src.results.processing.get_set_difference data\\master.csv data\\diff.csv
      python -m src.results.processing.get_set_difference data\\master.csv data\\diff.csv --master-id-column id
    """
