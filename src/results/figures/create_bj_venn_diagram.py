...
Usage (examples):
  - python -m src.results.figures.create_bj_venn_diagram --results-csv data/2025_10_18_Final_Results_with_best_judgement.csv --output-path results/venn_best_judgement.png --group-by model_name --bj-distributions --bj-prefix results/bj_dist
