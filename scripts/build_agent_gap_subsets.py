...
Reads ``data/agent_coverage_gaps/<model>_agent_needs_reprocess.csv`` (or the
full missing/failed CSV) and writes filtered copies of
``data/git_good_bench_merge_commits_all.csv`` suitable for
``DATASET_CSV=... python -m src.cli.run_all``.
"""
